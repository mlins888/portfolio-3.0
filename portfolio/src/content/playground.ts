 ...
 *
 * Each shirt is its own real, individually-exported asset (see
 * src/assets/playground/shirt-*.svg) hung over the closet's empty rod — not
 * a crop or a redraw — which is what makes it independently
 * animatable/hoverable while still showing real artwork. Swapping any of
 * these: point the entry's `image` at a new asset in src/assets/ — the
 * component sizes whatever it's handed, same contract as the hero
 * illustration.
 *
...
import boardgamePlaceholder from "../assets/decor/boardgame-placeholder.svg";
...
export type PlaygroundPathway = MediaPathway | SocialBoardPathway;
...
export const playground = {
  ...
  pathways: [
    ...
    },
    {
      ...
      title: "Board game — in progress",
      description:
        "A tabletop game I designed and prototyped. Drop in real rules, box art, and photos here whenever they're ready.",
      image: boardgamePlaceholder,
      imageAlt: "Placeholder dice icon",
      tags: ["Tabletop", "Print & play"],
    },
    {
      id: "social",
      type: "social",
